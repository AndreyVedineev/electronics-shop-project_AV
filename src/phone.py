...
class Phone(Item):
    ...
    def __repr__(self):
        return f"{__class__.__name__}('{str(self.name)}', {str(self.price)}, {str(self.quantity)}, {str(self.number_of_sim)})"

    @classmethod
    def verify_sim(cls, number_of_sim):
